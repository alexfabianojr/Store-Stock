...
import static Application.services.CheckProductLogic.checkProductLogic;

public class CheckProductPanel {
    public static void checkProductPanel() {
        try {
